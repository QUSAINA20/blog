...
<head>
    ...
    <title>Contact Form you</title>
</head>
<body style="background-color: #f2f2f2; font-family: Arial, sans-serif;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #007bff;">Contact Form you</h2>
        <p style="font-size: 16px;">Hello,</p>
        <p style="font-size: 16px;">You have sent a new message from the contact form on our website:</p>
